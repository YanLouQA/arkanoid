// переменная для работы с холстом, на котором будет нарисована игра
  ...
  const level1 = [
    ...
    ['C','R','C','P','R','C','P','R','C','P','R','C','P','R'],
    ['R','C','R','C','P','R','C','P','R','C','P','R','C','P'],
    ['P','R','C','R','C','P','R','C','P','R','C','P','R','C'],
    ['C','P','R','C','R','C','P','R','C','P','R','C','P','R'],
    ['R','C','P','R','C','R','C','P','R','C','P','R','C','P'],
    ['P','R','C','P','R','C','R','C','P','R','C','P','R','C'],
    ['C','P','R','C','P','R','C','R','C','P','R','C','P','R'],
    ['R','C','P','R','C','P','R','C','R','C','P','R','C','P'],
    ['P','R','C','P','R','C','P','R','C','R','C','P','R','C']
  ];
  ...
  function touchdown(t_brick) {
    ...
    switch(t_brick.color) {
      case "darkred" : score += 1; break;
      case "LightCoral"  : score += 2; break;
      case "lightpink" : score += 3; break;
    }
...
if (ball.y > canvas.height) {
  ...
  ball.dy = 0;
    ...
    context.fillRect(0, -47, wallSize, canvas.height);
    context.fillRect(canvas.width - wallSize, -47, wallSize, canvas.height);
    ...
    context.fillText('Score: ' + score, 50, 47);    
    // Затем — набранные очки    
    context.fillText('Lives:'+ lives, 250, 47);
  }
